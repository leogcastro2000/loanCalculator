...
# Create a user defined class named LoanCalculator which holds its own data members and member functions
...
class LoanCalculator:
    def __init__(self):
        ...
        Label(window, font="Helvetica 12 bold", bg="light green", text="Number of Years").grid(row=2, column=1,
                                                                                               sticky=W)
        Label(window, font="Helvetica 12 bold", bg="light green", text="Loan Amount").grid(row=3, column=1,
                                                                                           sticky=W)
        Label(window, font="Helvetica 12 bold", bg="light green", text="Monthly Payment").grid(row=4, column=1,
                                                                                               sticky=W)
        Label(window, font="Helvetica 12 bold", bg="light green", text="Total Payment").grid(row=5, column=1,
                                                                                             sticky=W)
        ...
        # create buttons to calculate payment. When button is clicked it will call the compute payment function
